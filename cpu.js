...
var cpu = {
    ...
    operations: {
        ...
        MAPcb: function() {
            ...
            cpu.registers.pc++
            cpu.registers.pc &= 65535
            console.log(`MAPcb m start = ${cpu.registers.m}`)
            
            if (cpu.cbMap[pcAdd]) {
                console.log(`cb mapping = ${pcAdd}, ${cpu.cbMap[pcAdd].toString}`)
                cpu.cbMap[pcAdd]()
            } else {
                console.log(pcAdd)
            }
...
cpu.cbMap = {
    ...
    0xcb06: cpu?.operations?.RLCHL,
    0xcb07: cpu?.operations?.RLCr_a,
    0xcb08: cpu?.operations?.RRCr_b,
    0xcb09: cpu?.operations?.RRCr_c,
    0xcb0a: cpu?.operations?.RRCr_d,
    0xcb0b: cpu?.operations?.RRCr_e,
    0xcb0c: cpu?.operations?.RRCr_h,
    0xcb0d: cpu?.operations?.RRCr_l,
    0xcb0e: cpu?.operations?.RRCHL,
    0xcb0f: cpu?.operations?.RRCr_a,
    0xcb10: cpu?.operations?.RLr_b,
    0xcb11: cpu?.operations?.RLr_c,
    0xcb12: cpu?.operations?.RLr_d,
    0xcb13: cpu?.operations?.RLr_e,
    0xcb14: cpu?.operations?.RLr_h,
    0xcb15: cpu?.operations?.RLr_l,
    0xcb16: cpu?.operations?.RLHL,
    0xcb17: cpu?.operations?.RLr_a,
    0xcb18: cpu?.operations?.RRr_b,
    0xcb19: cpu?.operations?.RRr_c,
    0xcb1a: cpu?.operations?.RRr_d,
    0xcb1b: cpu?.operations?.RRr_e,
    0xcb1c: cpu?.operations?.RRr_h,
    0xcb1d: cpu?.operations?.RRr_l,
    0xcb1e: cpu?.operations?.RRHL,
    0xcb1f: cpu?.operations?.RRr_a,
    0xcb20: cpu?.operations?.SLAr_b,
    0xcb21: cpu?.operations?.SLAr_c,
    0xcb22: cpu?.operations?.SLAr_d,
    0xcb23: cpu?.operations?.SLAr_e,
    0xcb24: cpu?.operations?.SLAr_h,
    0xcb25: cpu?.operations?.SLAr_l,
    0xcb26: cpu?.operations?.noSuchOpCode,
    0xcb27: cpu?.operations?.SLAr_a,
    0xcb28: cpu?.operations?.SRAr_b,
    0xcb29: cpu?.operations?.SRAr_c,
    0xcb2a: cpu?.operations?.SRAr_d,
    0xcb2b: cpu?.operations?.SRAr_e,
    0xcb2c: cpu?.operations?.SRAr_h,
    0xcb2d: cpu?.operations?.SRAr_l,
    0xcb2e: cpu?.operations?.noSuchOpCode,
    0xcb2f: cpu?.operations?.SRAr_a,
    0xcb30: cpu?.operations?.SWAPr_b,
    0xcb31: cpu?.operations?.SWAPr_c,
    0xcb32: cpu?.operations?.SWAPr_d,
    0xcb33: cpu?.operations?.SWAPr_e,
    0xcb34: cpu?.operations?.SWAPr_h,
    0xcb35: cpu?.operations?.SWAPr_l,
    0xcb36: cpu?.operations?.noSuchOpCode,
    0xcb37: cpu?.operations?.SWAPr_a,
    0xcb38: cpu?.operations?.SRLr_b,
    0xcb39: cpu?.operations?.SRLr_c,
    0xcb3a: cpu?.operations?.SRLr_d,
    0xcb3b: cpu?.operations?.SRLr_e,
    0xcb3c: cpu?.operations?.SRLr_h,
    0xcb3d: cpu?.operations?.SRLr_l,
    0xcb3e: cpu?.operations?.noSuchOpCode,
    0xcb3f: cpu?.operations?.SRLr_a,
    0xcb40: cpu?.operations?.BIT0b,
    0xcb41: cpu?.operations?.BIT0c,
    0xcb42: cpu?.operations?.BIT0d,
    0xcb43: cpu?.operations?.BIT0e,
    0xcb44: cpu?.operations?.BIT0h,
    0xcb45: cpu?.operations?.BIT0l,
    0xcb46: cpu?.operations?.BIT0m,
    0xcb47: cpu?.operations?.BIT0a,
    0xcb48: cpu?.operations?.BIT1b,
    0xcb49: cpu?.operations?.BIT1c,
    0xcb4a: cpu?.operations?.BIT1d,
    0xcb4b: cpu?.operations?.BIT1e,
    0xcb4c: cpu?.operations?.BIT1h,
    0xcb4d: cpu?.operations?.BIT1l,
    0xcb4e: cpu?.operations?.BIT1m,
    0xcb4f: cpu?.operations?.BIT1a,
    0xcb50: cpu?.operations?.BIT2b,
    0xcb51: cpu?.operations?.BIT2c,
    0xcb52: cpu?.operations?.BIT2d,
    0xcb53: cpu?.operations?.BIT2e,
    0xcb54: cpu?.operations?.BIT2h,
    0xcb55: cpu?.operations?.BIT2l,
    0xcb56: cpu?.operations?.BIT2m,
    0xcb57: cpu?.operations?.BIT2a,
    0xcb58: cpu?.operations?.BIT3b,
    0xcb59: cpu?.operations?.BIT3c,
    0xcb5a: cpu?.operations?.BIT3d,
    0xcb5b: cpu?.operations?.BIT3e,
    0xcb5c: cpu?.operations?.BIT3h,
    0xcb5d: cpu?.operations?.BIT3l,
    0xcb5e: cpu?.operations?.BIT3m,
    0xcb5f: cpu?.operations?.BIT3a,
    0xcb60: cpu?.operations?.BIT4b,
    0xcb61: cpu?.operations?.BIT4c,
    0xcb62: cpu?.operations?.BIT4d,
    0xcb63: cpu?.operations?.BIT4e,
    0xcb64: cpu?.operations?.BIT4h,
    0xcb65: cpu?.operations?.BIT4l,
    0xcb66: cpu?.operations?.BIT4m,
    0xcb67: cpu?.operations?.BIT4a,
    0xcb68: cpu?.operations?.BIT5b,
    0xcb69: cpu?.operations?.BIT5c,
    0xcb6a: cpu?.operations?.BIT5d,
    0xcb6b: cpu?.operations?.BIT5e,
    0xcb6c: cpu?.operations?.BIT5h,
    0xcb6d: cpu?.operations?.BIT5l,
    0xcb6e: cpu?.operations?.BIT5m,
    0xcb6f: cpu?.operations?.BIT5a,
    0xcb70: cpu?.operations?.BIT6b,
    0xcb71: cpu?.operations?.BIT6c,
    0xcb72: cpu?.operations?.BIT6d,
    0xcb73: cpu?.operations?.BIT6e,
    0xcb74: cpu?.operations?.BIT6h,
    0xcb75: cpu?.operations?.BIT6l,
    0xcb76: cpu?.operations?.BIT6m,
    0xcb77: cpu?.operations?.BIT6a,
    0xcb78: cpu?.operations?.BIT7b,
    0xcb79: cpu?.operations?.BIT7c,
    0xcb7a: cpu?.operations?.BIT7d,
    0xcb7b: cpu?.operations?.BIT7e,
    0xcb7c: cpu?.operations?.BIT7h,
    0xcb7d: cpu?.operations?.BIT7l,
    0xcb7e: cpu?.operations?.BIT7m,
    0xcb7f: cpu?.operations?.BIT7a,
    0xcb80: cpu?.operations?.RES0b,
    0xcb81: cpu?.operations?.RES0c,
    0xcb82: cpu?.operations?.RES0d,
    0xcb83: cpu?.operations?.RES0e,
    0xcb84: cpu?.operations?.RES0h,
    0xcb85: cpu?.operations?.RES0l,
    0xcb86: cpu?.operations?.RES0m,
    0xcb87: cpu?.operations?.RES0a,
    0xcb88: cpu?.operations?.RES1b,
    0xcb89: cpu?.operations?.RES1c,
    0xcb8a: cpu?.operations?.RES1d,
    0xcb8b: cpu?.operations?.RES1e,
    0xcb8c: cpu?.operations?.RES1h,
    0xcb8d: cpu?.operations?.RES1l,
    0xcb8e: cpu?.operations?.RES1m,
    0xcb8f: cpu?.operations?.RES1a,
    0xcb90: cpu?.operations?.RES2b,
    0xcb91: cpu?.operations?.RES2c,
    0xcb92: cpu?.operations?.RES2d,
    0xcb93: cpu?.operations?.RES2e,
    0xcb94: cpu?.operations?.RES2h,
    0xcb95: cpu?.operations?.RES2l,
    0xcb96: cpu?.operations?.RES2m,
    0xcb97: cpu?.operations?.RES2a,
    0xcb98: cpu?.operations?.RES3b,
    0xcb99: cpu?.operations?.RES3c,
    0xcb9a: cpu?.operations?.RES3d,
    0xcb9b: cpu?.operations?.RES3e,
    0xcb9c: cpu?.operations?.RES3h,
    0xcb9d: cpu?.operations?.RES3l,
    0xcb9e: cpu?.operations?.RES3m,
    0xcb9f: cpu?.operations?.RES3a,
    0xcba0: cpu?.operations?.RES4b,
    0xcba1: cpu?.operations?.RES4c,
    0xcba2: cpu?.operations?.RES4d,
    0xcba3: cpu?.operations?.RES4e,
    0xcba4: cpu?.operations?.RES4h,
    0xcba5: cpu?.operations?.RES4l,
    0xcba6: cpu?.operations?.RES4m,
    0xcba7: cpu?.operations?.RES4a,
    0xcba8: cpu?.operations?.RES5b,
    0xcba9: cpu?.operations?.RES5c,
    0xcbaa: cpu?.operations?.RES5d,
    0xcbab: cpu?.operations?.RES5e,
    0xcbac: cpu?.operations?.RES5h,
    0xcbad: cpu?.operations?.RES5l,
    0xcbae: cpu?.operations?.RES5m,
    0xcbaf: cpu?.operations?.RES5a,
    0xcbb0: cpu?.operations?.RES6b,
    0xcbb1: cpu?.operations?.RES6c,
    0xcbb2: cpu?.operations?.RES6d,
    0xcbb3: cpu?.operations?.RES6e,
    0xcbb4: cpu?.operations?.RES6h,
    0xcbb5: cpu?.operations?.RES6l,
    0xcbb6: cpu?.operations?.RES6m,
    0xcbb7: cpu?.operations?.RES6a,
    0xcbb8: cpu?.operations?.RES7b,
    0xcbb9: cpu?.operations?.RES7c,
    0xcbba: cpu?.operations?.RES7d,
    0xcbbb: cpu?.operations?.RES7e,
    0xcbbc: cpu?.operations?.RES7h,
    0xcbbd: cpu?.operations?.RES7l,
    0xcbbe: cpu?.operations?.RES7m,
    0xcbbf: cpu?.operations?.RES7a,
    0xcbc0: cpu?.operations?.SET0b,
    0xcbc1: cpu?.operations?.SET0c,
    0xcbc2: cpu?.operations?.SET0d,
    0xcbc3: cpu?.operations?.SET0e,
    0xcbc4: cpu?.operations?.SET0h,
    0xcbc5: cpu?.operations?.SET0l,
    0xcbc6: cpu?.operations?.SET0m,
    0xcbc7: cpu?.operations?.SET0a,
    0xcbc8: cpu?.operations?.SET1b,
    0xcbc9: cpu?.operations?.SET1c,
    0xcbca: cpu?.operations?.SET1d,
    0xcbcb: cpu?.operations?.SET1e,
    0xcbcc: cpu?.operations?.SET1h,
    0xcbcd: cpu?.operations?.SET1l,
    0xcbce: cpu?.operations?.SET1m,
    0xcbcf: cpu?.operations?.SET1a,
    0xcbd0: cpu?.operations?.SET2b,
    0xcbd1: cpu?.operations?.SET2c,
    0xcbd2: cpu?.operations?.SET2d,
    0xcbd3: cpu?.operations?.SET2e,
    0xcbd4: cpu?.operations?.SET2h,
    0xcbd5: cpu?.operations?.SET2l,
    0xcbd6: cpu?.operations?.SET2m,
    0xcbd7: cpu?.operations?.SET2a,
    0xcbd8: cpu?.operations?.SET3b,
    0xcbd9: cpu?.operations?.SET3c,
    0xcbda: cpu?.operations?.SET3d,
    0xcbdb: cpu?.operations?.SET3e,
    0xcbdc: cpu?.operations?.SET3h,
    0xcbdd: cpu?.operations?.SET3l,
    0xcbde: cpu?.operations?.SET3m,
    0xcbdf: cpu?.operations?.SET3a,
    0xcbe0: cpu?.operations?.SET4b,
    0xcbe1: cpu?.operations?.SET4c,
    0xcbe2: cpu?.operations?.SET4d,
    0xcbe3: cpu?.operations?.SET4e,
    0xcbe4: cpu?.operations?.SET4h,
    0xcbe5: cpu?.operations?.SET4l,
    0xcbe6: cpu?.operations?.SET4m,
    0xcbe7: cpu?.operations?.SET4a,
    0xcbe8: cpu?.operations?.SET5b,
    0xcbe9: cpu?.operations?.SET5c,
    0xcbea: cpu?.operations?.SET5d,
    0xcbeb: cpu?.operations?.SET5e,
    0xcbec: cpu?.operations?.SET5h,
    0xcbed: cpu?.operations?.SET5l,
    0xcbee: cpu?.operations?.SET5m,
    0xcbef: cpu?.operations?.SET5a,
    0xcbf0: cpu?.operations?.SET6b,
    0xcbf1: cpu?.operations?.SET6c,
    0xcbf2: cpu?.operations?.SET6d,
    0xcbf3: cpu?.operations?.SET6e,
    0xcbf4: cpu?.operations?.SET6h,
    0xcbf5: cpu?.operations?.SET6l,
    0xcbf6: cpu?.operations?.SET6m,
    0xcbf7: cpu?.operations?.SET6a,
    0xcbf8: cpu?.operations?.SET7b,
    0xcbf9: cpu?.operations?.SET7c,
    0xcbfa: cpu?.operations?.SET7d,
    0xcbfb: cpu?.operations?.SET7e,
    0xcbfc: cpu?.operations?.SET7h,
    0xcbfd: cpu?.operations?.SET7l,
    0xcbfe: cpu?.operations?.SET7m,
